    ...
    <div className='bg-secondary w-full h-screen text-white flex flex-col justify-between'>
      <div>
        ...
        <ul>
          ...
          <li className='border-b border-b-white/50'><Link className={clsx('flex items-center px-4 py-2', pathname === ADMIN_ROUTES.POST_ADMIN_PAGE ?'bg-secondary-hover' : '')} href={ADMIN_ROUTES.POST_ADMIN_PAGE}><FaRegEdit size={20} className='mr-2' /> Post</Link></li>
