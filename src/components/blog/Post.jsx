    ...
    <FadeUpAnimation>
      <div className='bg-light-coffee/10 rounded-2xl overflow-hidden h-full'>
        <div className={cx(
          ...
          <Link href={url} className='ct-button absolute left-4 right-4 bottom-4 xl:bottom-0 z-30 bg-white text-center text-light-coffee text-base py-4 font-bold hover:bg-light-coffee hover:text-white opacity-100 xl:opacity-0 group-hover:bottom-4 group-hover:opacity-100 uppercase'>Read the full story</Link>
        </div>
