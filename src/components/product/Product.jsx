...
const Product = ({ images = [], name, isOnSale = false, url = '#', originPrice, promotionPrice = null }) => {
  return (
    <FadeUpAnimation>
      <div className='bg-light-coffee/10 rounded-2xl overflow-hidden'>
        <div className={clsx(
          ...
          <img src={images[0]} className='object-cover object-center group-hover:scale-110 transition-all duration-300 w-full' alt={name} />
